...
# DO NOT CONFUSE WITH modify_art_csv.py

import csv
import os
import random

filename_input = 'four_classes_input.csv'
filename_output = 'four_classes_output.csv'

path = "/Users/zoe/Documents/classes-sp22/9.60/960_html/Pandora_4_classes"
    ...
    for (root, dirs, file) in os.walk(path):
        for f in file:
            if '.jpg' in f:
                ...
                print("filepath")
                print(filepath)
                last_part = filepath.split("Pandora_4_classes/")[1]
...
with open(filename_output, 'w') as csvfile_output:
    with open(filename_input, 'r') as csvfile_input:
        ...
        for row in reader:
            prev_row = row
            prefix = "https://9604artstylesurvey.s3.amazonaws.com/"
...
for i in range(0, 10):
    ...
    print(random_15)
    try:
        os.mkdir("random_15_4_classes") 
    except OSError as error: 
        print(error)  
    with open("random_15_4_classes/random_15_" + str(i) + ".csv", 'w') as random_csvfile:
